...
public class UpdateSpawners_1_15_R1 implements Morphable {
    @Override
    public void update(Block blockPlaced, String spawnedType, int spawnCount, int minSpawnDelay, int maxSpawnDelay, boolean isBreaking, boolean isChanging) {
        net.minecraft.server.v1_15_R1.BlockPosition blockPosition = new BlockPosition(blockPlaced.getX(), blockPlaced.getY(), blockPlaced.getZ());
